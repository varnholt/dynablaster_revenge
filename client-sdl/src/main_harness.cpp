...
// (--click, --realclick), page inspection (--dumplayer, --page), an isolated-effect view
// (--logo3d), and a standalone castle-level demo (the default mode with no flags at all) - none
// of which belong in the real game binary. See CMakeLists.txt for how this and dynablaster_sdl
// share the same dynablaster_core library.
#include "gles3.h"
