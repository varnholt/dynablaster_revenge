...
void LevelCastle::initialize()
{
   ...
   LensFlareFactory::getInstance()->activate("castle");
}
...
void LevelCastle::draw()
{
   ...
   {
      glPushMatrix();
      glTranslatef(-8.0f, -17.0f, 0.0f); // -8 => compensate wind
...
/*
   // save bomb mesh as obj
   SceneGraph* fuck= new SceneGraph();
   fuck->load("bomb.hjb");
   fuck->exportOBJ("bomb.obj");
*/
